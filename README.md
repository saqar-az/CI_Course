...
| **Fuzzy Temperature Controller** | Design a fuzzy controller to maintain room temperature at approximately 22°C. | 
| **Genetic** | Use genetic programming to discover a closed-form mathematical expression from data. |
